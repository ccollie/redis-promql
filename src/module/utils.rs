use std::borrow::Cow;
use valkey_module::{CallOptionResp, CallOptions, CallOptionsBuilder, CallResult, Context, ValkeyError, ValkeyResult, ValkeyValue};
...
pub(crate) fn redis_value_as_str(value: &ValkeyValue) -> ValkeyResult<Cow<str>> {
    match value {
...
pub(crate) fn redis_value_as_string(value: &ValkeyValue) -> ValkeyResult<Cow<String>> {
    match value {
...
pub(crate) fn call_redis_command<'a>(ctx: &Context, cmd: &'a str, args: &'a [String]) -> ValkeyResult {
