...
use crate::gorilla::stream::Write;
use crate::gorilla::{Bit, DataPoint};
...
pub(crate) struct StdEncoder<T: Write> {
    ...
    pub first: bool, // will next DataPoint be the first DataPoint encoded
    pub count: usize,  // number of DataPoints encoded
...
#[cfg(test)]
mod tests {
    use super::{DataPoint, Encode, StdEncoder};
    use crate::gorilla::stream::BufferedWriter;
