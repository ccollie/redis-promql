...
impl DurationRoundable<NaiveDateTime> for NaiveDateTime{
    fn get_utc_millis_since_epoch(&self) -> i64{
...
impl<TZInfo: TimeZone> DurationRoundable<DateTime<TZInfo>> for DateTime<TZInfo>{
    fn get_utc_millis_since_epoch(&self) -> i64{
...
where TDate : DurationRoundable<TDate>
{
